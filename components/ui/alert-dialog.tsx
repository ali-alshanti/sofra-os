  ...
  return (
    <AlertDialogPrimitive.Action
      ...
      className={cn(
        ...
        "bg-destructive text-destructive-foreground shadow-xs hover:brightness-110 transition-all",
...
function AlertDialogCancel({ className, ...props }: React.ComponentProps<typeof AlertDialogPrimitive.Cancel>) {
  return (
    <AlertDialogPrimitive.Cancel
      ...
      className={cn(
        "inline-flex h-9 items-center justify-center gap-2 rounded-lg border border-border px-4 text-sm font-medium",
